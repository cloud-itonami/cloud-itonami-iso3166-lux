(ns marketentry.marketentryllm
  ...
  the Luxembourg (LUX) public-sector market-entry compliance actor.
    ...
    {:summary    (str subject " 向けポータル提出提案"
     ...
     :rationale  (if e
                   (str "contract-value=" (:contract-value e)
                        " light-touch-procedure-claim?=" (:light-touch-procedure-claim? e)
                        " requires-etablissement-authorization?=" (:requires-etablissement-authorization? e)
     ...
     :confidence (if (and e
                          (or (not (:requires-etablissement-authorization? e))
                              (:etablissement-fixed-place-not-domiciliation-only? e)))
                   0.9 0.3)}))
